...
import { Dialog, DialogContent, DialogTitle, Slide, DialogActions, DialogContentText, Alert } from '@mui/material/';
            ...
            <>
                <React.Fragment>
                    <TableRow sx={{ '& > *': { borderBottom: 'unset' } }} hover={true} onClick={() => setOpen(!open)}>
                        ...
                        <TableCell>{row.product_type.toUpperCase()}</TableCell>
                ...
                <div className="col-lg-10">
                    <div>
                        <div className="comhed">
                            ...
                            <h6>Admin / Master Data Management / Bills of Materials</h6>
                        </div>
                        <div className='tablepadding'>
                            {token == null || token == '' ?
