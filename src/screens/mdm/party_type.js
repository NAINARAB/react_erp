...
const createpartytype = (sno, partttype, action) => {
    return { sno, partttype, action }
}
...
const PartyTypeRows = [
    createpartytype(1, 'Clean', <Butns />),
    createpartytype(1, 'Clean', <Butns />),
    createpartytype(1, 'Clean', <Butns />),
    createpartytype(6, 'Clean', <Butns />),
    createpartytype(1, 'Clean', <Butns />),
    createpartytype(1, 'Clean', <Butns />),
]
                    ...
                    <Table stickyHeader sx={{ minWidth: 650 }} aria-label="simple table">
                        ...
                        <TableBody>
                            {PartyTypeRows.map((ptr) => (
                                <TableRow hover='true'>
                                    <TableCell >{ptr.sno}</TableCell>
                                    <TableCell>{ptr.partttype}</TableCell>
                                    <TableCell align="left">{ptr.action}</TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>
...
function Partytype() {
    ...
    const [disppartytypes, setdisppartytypes ] = useState(<PartyTypecomp />);
        ...
        return (
            <>
                ...
                <button className="cancelbtn" onClick={() => {
                    setdisppartytypes(<PartyTypecomp />)
                ...
                <div className="col-lg-10">
                    <div>
                        <div className="comhed">
                            <button className="comadbtn" id='prtytypeadbtn' onClick={() => {setdisppartytypes(<AddPartyType />)
